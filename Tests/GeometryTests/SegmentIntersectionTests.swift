...
struct SegmentIntersectionTests {
    ...
    func testParallelSegments() {
        let s1 = LineSegment(start: CGPoint.zero, end: CGPoint(x: 10, y: 0))
    ...
    func testNonIntersectingSegments() {
        let s1 = LineSegment(start: CGPoint.zero, end: CGPoint(x: 5, y: 0))
    ...
    func testDifferentSlopes() {
        let s1 = LineSegment(start: CGPoint.zero, end: CGPoint(x: 10, y: 5))
