...
struct ThickenTests {
    ...
    func testThickenSingleSegment() {
        let segment = LineSegment(start: CGPoint.zero, end: CGPoint(x: 10, y: 0))
    ...
    func testThickenMultipleSegmentsWithJunction() {
        ...
        let segments = [
            LineSegment(start: CGPoint.zero, end: CGPoint(x: 5, y: 5)),
    ...
    func testThickenRemovesDuplicates() {
        let segment1 = LineSegment(start: CGPoint.zero, end: CGPoint(x: 10, y: 0))
        let segment2 = LineSegment(start: CGPoint(x: 10, y: 0), end: CGPoint.zero) // Reversed duplicate
    ...
    func testThickenJunctionMultipleVertices() {
        ...
        for segment in result {
            #expect(segment.start == CGPoint.zero)
