...
struct TJunctionsTests {
    ...
    func testCrossIntersection() {
        ...
        let segment1 = LineSegment(start: CGPoint.zero, end: CGPoint(x: 10, y: 10))
    ...
    func testTJunctionAtStart() {
        let horizontal = LineSegment(start: CGPoint(x: 0, y: 5), end: CGPoint(x: 10, y: 5))
        let vertical = LineSegment(start: CGPoint.zero, end: CGPoint(x: 0, y: 5))
    ...
    func testCollinearSegments() {
        ...
        let segment1 = LineSegment(start: CGPoint.zero, end: CGPoint(x: 5, y: 0))
