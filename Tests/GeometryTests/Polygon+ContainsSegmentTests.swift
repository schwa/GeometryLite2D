...
struct PolygonContainsSegmentTests {
    ...
    func testPolygonContainsSegmentEdgeCases() {
        ...
        // Edge of square
        #expect(square.contains(LineSegment(CGPoint.zero, CGPoint(x: 10.0, y: 0.0))) == false)
        ...
        #expect(square.contains(LineSegment(CGPoint.zero, CGPoint(x: 10.0, y: 10.0))) == false)
    ...
    func testPolygonContainsPointWithBoundary() {
        ...
        #expect(square.contains(CGPoint.zero) == true)    // Vertex
    ...
    func testPolygonContainsPointConcave() {
        ...
        #expect(lShape.contains(CGPoint.zero) == true)
