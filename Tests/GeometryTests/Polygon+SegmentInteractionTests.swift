...
struct PolygonSegmentInteractionTests {
    ...
    func testSquareContainsSegmentVariations() {
        ...
        let bottomEdge = LineSegment(CGPoint(x: 0, y: 0), CGPoint(x: 10, y: 0))
        ...
        let leftEdge = LineSegment(CGPoint(x: 0, y: 0), CGPoint(x: 0, y: 10))
        ...
        let cornerDiagonal = LineSegment(CGPoint(x: 0, y: 0), CGPoint(x: 10, y: 10))
        ...
        let vertexToInside = LineSegment(CGPoint(x: 0, y: 0), CGPoint(x: 5, y: 5))
        ...
        let touchingCorner = LineSegment(CGPoint(x: -2, y: -2), CGPoint(x: 0, y: 0))
    ...
    func testTriangleContainsSegmentVariations() {
        ...
        // Edge segment
        let edge = LineSegment(CGPoint(x: 0, y: 0), CGPoint(x: 10, y: 0))
        ...
        let vertexToInside = LineSegment(CGPoint(x: 0, y: 0), CGPoint(x: 2, y: 2))
