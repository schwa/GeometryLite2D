...
struct LineSegmentContainsTests {
    ...
    func testLineSegmentContainsPoint() {
        // Horizontal segment
        let horizontal = LineSegment(CGPoint.zero, CGPoint(x: 10, y: 0))

        // Points on the segment
        #expect(horizontal.contains(CGPoint.zero, absoluteTolerance: 1e-5) == true)    // Start point
        ...
        // Vertical segment
        let vertical = LineSegment(CGPoint.zero, CGPoint(x: 0, y: 10))

        #expect(vertical.contains(CGPoint.zero, absoluteTolerance: 1e-5) == true)     // Start
        ...
        // Diagonal segment
        let diagonal = LineSegment(CGPoint.zero, CGPoint(x: 10, y: 10))

        #expect(diagonal.contains(CGPoint.zero, absoluteTolerance: 1e-5) == true)     // Start
    ...
    func testLineSegmentContainsPointTolerance() {
        let segment = LineSegment(CGPoint.zero, CGPoint(x: 10, y: 0))
    ...
    func testLineSegmentContainsLineSegment() {
        ...
        #expect(segment.contains(LineSegment(CGPoint.zero, CGPoint(x: 5, y: 0))) == true)
        ...
        #expect(segment.contains(LineSegment(CGPoint.zero, CGPoint(x: 10, y: 10))) == false)
