...
struct SplitterTests {
    ...
    func testBasicSplit() {
        ...
        let segments = [
            Identified(id: "A", value: LineSegment(start: CGPoint(x: 0, y: 0), end: CGPoint(x: 10, y: 10))),
    ...
    func testNoSplit() {
        let segments = [
            Identified(id: 1, value: LineSegment(start: CGPoint(x: 0, y: 0), end: CGPoint(x: 10, y: 0))),
    ...
    func testEndpointIntersection() {
        ...
        let segments = [
            Identified(id: "A", value: LineSegment(start: CGPoint(x: 0, y: 0), end: CGPoint(x: 5, y: 5))),
    ...
    func testDiagonalIntersection() {
        ...
        let segments = [
            Identified(id: "D1", value: LineSegment(start: CGPoint(x: 0, y: 0), end: CGPoint(x: 6, y: 6))),
    ...
    func testSingleSegment() {
        let segments = [
            Identified(id: "only", value: LineSegment(start: CGPoint(x: 0, y: 0), end: CGPoint(x: 10, y: 10)))
        ]
